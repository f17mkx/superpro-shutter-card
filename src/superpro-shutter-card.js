  ...
  showCentralWindow(){
    ...
    return html`
      <div class="${ESC_CLASS_SELECTOR}">
        ...
        ${windowSrc ? html`<img src= "${windowSrc} ">` : ''}
...
// Test surface: vitest reaches in here for the pure-logic suite. Rollup's
// IIFE bundle drops these named exports silently (they have no runtime
// cost outside ESM consumers), so the dist artefact is unaffected.
export {
  // version + identity
  VERSION,
  HA_CARD_NAME,
